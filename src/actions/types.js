...
export const GET_FEAT_BOOKS = 'GET_FEAT_BOOKS';
export const GET_FEAT_BOOKSTORE = 'GET_FEAT_BOOKSTORE';
export const GET_NOTIFICATIONS = 'GET_NOTIFICATIONS';
export const NOT_SEEN_NOTIFICATIONS = 'NOT_SEEN_NOTIFICATIONS';
export const SEEN_NOTIFICATIONS = 'SEEN_NOTIFICATIONS';
export const SEND_NOTIFICATION = 'SEND_NOTIFICATION';
export const USER_UPDATE = 'USER_UPDATE';
export const UPDATE_PROPIX = 'UPDATE_PROPIX';
